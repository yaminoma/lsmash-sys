...
int lsmash_convert_crop_into_clap(lsmash_crop_t crop, uint32_t width,
                                  uint32_t height, lsmash_clap_t *clap) {
  if (!clap || crop.top.d == 0 || crop.bottom.d == 0 || crop.left.d == 0 ||
      crop.right.d == 0)
  ...
  clap_height.n = height * vertical_crop_lcm -
                  (crop.top.n * (vertical_crop_lcm / crop.top.d) +
                   crop.bottom.n * (vertical_crop_lcm / crop.bottom.d));
  clap_width.n = width * horizontal_crop_lcm -
                 (crop.left.n * (horizontal_crop_lcm / crop.left.d) +
                  crop.right.n * (horizontal_crop_lcm / crop.right.d));
  clap_horizontal_offset.n =
      (int64_t)(crop.left.n * (horizontal_crop_lcm / crop.left.d)) -
      crop.right.n * (horizontal_crop_lcm / crop.right.d);
  clap_vertical_offset.n =
      (int64_t)(crop.top.n * (vertical_crop_lcm / crop.top.d)) -
      crop.bottom.n * (vertical_crop_lcm / crop.bottom.d);
  ...
  lsmash_reduce_fraction_su(&clap_horizontal_offset.n,
                            &clap_horizontal_offset.d);
  clap->height = (lsmash_rational_u32_t){clap_height.n, clap_height.d};
  clap->width = (lsmash_rational_u32_t){clap_width.n, clap_width.d};
  clap->vertical_offset =
      (lsmash_rational_s32_t){clap_vertical_offset.n, clap_vertical_offset.d};
  clap->horizontal_offset = (lsmash_rational_s32_t){clap_horizontal_offset.n,
                                                    clap_horizontal_offset.d};
  return 0;
}

int lsmash_convert_clap_into_crop(lsmash_clap_t clap, uint32_t width,
                                  uint32_t height, lsmash_crop_t *crop) {
  if (!crop || clap.height.d == 0 || clap.vertical_offset.d == 0 ||
      clap.width.d == 0 || clap.horizontal_offset.d == 0)
    return LSMASH_ERR_FUNCTION_PARAM;
  uint64_t clap_vertical_lcm =
      lsmash_get_lcm(clap.height.d, clap.vertical_offset.d);
  uint64_t clap_horizontal_lcm =
      lsmash_get_lcm(clap.width.d, clap.horizontal_offset.d);
  ...
  crop_top.n =
      (height * crop_top.d - clap.height.n * (crop_top.d / clap.height.d)) / 2 +
      clap.vertical_offset.n * (crop_top.d / clap.vertical_offset.d);
  crop_bottom.n =
      (height * crop_bottom.d -
       clap.height.n * (crop_bottom.d / clap.height.d)) /
          2 -
      clap.vertical_offset.n * (crop_bottom.d / clap.vertical_offset.d);
  crop_left.n =
      (width * crop_left.d - clap.width.n * (crop_left.d / clap.width.d)) / 2 +
      clap.horizontal_offset.n * (crop_left.d / clap.horizontal_offset.d);
  crop_right.n =
      (width * crop_right.d - clap.width.n * (crop_right.d / clap.width.d)) /
          2 -
...
static void isom_destruct_nothing(void *data) { /* Do nothing. */; }

static int isom_initialize_structured_codec_specific_data(
...
static inline int
isom_initialize_codec_specific_data(lsmash_codec_specific_t *specific,
...
static int
isom_duplicate_structured_specific_data(lsmash_codec_specific_t *dst,
                                        lsmash_codec_specific_t *src) {
  extern int mp4sys_copy_decoder_config(lsmash_codec_specific_t *,
                                        lsmash_codec_specific_t *);
  extern int h264_copy_codec_specific(lsmash_codec_specific_t *,
                                      lsmash_codec_specific_t *);
  extern int hevc_copy_codec_specific(lsmash_codec_specific_t *,
                                      lsmash_codec_specific_t *);
  extern int vc1_copy_codec_specific(lsmash_codec_specific_t *,
                                     lsmash_codec_specific_t *);
  extern int dts_copy_codec_specific(lsmash_codec_specific_t *,
                                     lsmash_codec_specific_t *);
  ...
  case LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_AUDIO_AC_3:
    *(lsmash_ac3_specific_parameters_t *)dst_data =
        *(lsmash_ac3_specific_parameters_t *)src_data;
    return 0;
  case LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_AUDIO_EC_3:
    *(lsmash_eac3_specific_parameters_t *)dst_data =
        *(lsmash_eac3_specific_parameters_t *)src_data;
    return 0;
  case LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_AUDIO_DTS:
    return dts_copy_codec_specific(dst, src);
  case LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_AUDIO_ALAC:
    *(lsmash_alac_specific_parameters_t *)dst_data =
        *(lsmash_alac_specific_parameters_t *)src_data;
    return 0;
  case LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_VIDEO_SAMPLE_SCALE:
    *(lsmash_isom_sample_scale_t *)dst_data =
        *(lsmash_isom_sample_scale_t *)src_data;
    return 0;
  case LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_VIDEO_H264_BITRATE:
    *(lsmash_h264_bitrate_t *)dst_data = *(lsmash_h264_bitrate_t *)src_data;
    return 0;
  case LSMASH_CODEC_SPECIFIC_DATA_TYPE_QT_VIDEO_COMMON:
    *(lsmash_qt_video_common_t *)dst_data =
        *(lsmash_qt_video_common_t *)src_data;
    return 0;
  case LSMASH_CODEC_SPECIFIC_DATA_TYPE_QT_AUDIO_COMMON:
    *(lsmash_qt_audio_common_t *)dst_data =
        *(lsmash_qt_audio_common_t *)src_data;
    return 0;
  case LSMASH_CODEC_SPECIFIC_DATA_TYPE_QT_AUDIO_FORMAT_SPECIFIC_FLAGS:
    *(lsmash_qt_audio_format_specific_flags_t *)dst_data =
        *(lsmash_qt_audio_format_specific_flags_t *)src_data;
    return 0;
  case LSMASH_CODEC_SPECIFIC_DATA_TYPE_CODEC_GLOBAL_HEADER: {
    lsmash_codec_global_header_t *src_global =
        (lsmash_codec_global_header_t *)src_data;
    if (src_global->header_data && src_global->header_size) {
      lsmash_codec_global_header_t *dst_global =
          (lsmash_codec_global_header_t *)dst_data;
      dst_global->header_data =
          lsmash_memdup(src_global->header_data, src_global->header_size);
  ...
  case LSMASH_CODEC_SPECIFIC_DATA_TYPE_QT_VIDEO_FIELD_INFO:
    *(lsmash_qt_field_info_t *)dst_data = *(lsmash_qt_field_info_t *)src_data;
    return 0;
  case LSMASH_CODEC_SPECIFIC_DATA_TYPE_QT_VIDEO_PIXEL_FORMAT:
    *(lsmash_qt_pixel_format_t *)dst_data =
        *(lsmash_qt_pixel_format_t *)src_data;
    return 0;
  case LSMASH_CODEC_SPECIFIC_DATA_TYPE_QT_VIDEO_SIGNIFICANT_BITS:
    *(lsmash_qt_significant_bits_t *)dst_data =
        *(lsmash_qt_significant_bits_t *)src_data;
    return 0;
  case LSMASH_CODEC_SPECIFIC_DATA_TYPE_QT_VIDEO_GAMMA_LEVEL:
    *(lsmash_qt_gamma_t *)dst_data = *(lsmash_qt_gamma_t *)src_data;
    return 0;
  case LSMASH_CODEC_SPECIFIC_DATA_TYPE_QT_AUDIO_CHANNEL_LAYOUT:
    *(lsmash_qt_audio_channel_layout_t *)dst_data =
        *(lsmash_qt_audio_channel_layout_t *)src_data;
    return 0;
  default:
...
lsmash_codec_specific_t *
isom_duplicate_codec_specific_data(lsmash_codec_specific_t *specific) {
  if (!specific)
    return NULL;
  lsmash_codec_specific_t *dup =
      lsmash_create_codec_specific_data(specific->type, specific->format);
  if (!dup)
    return NULL;
  if (specific->format == LSMASH_CODEC_SPECIFIC_FORMAT_STRUCTURED) {
    ...
    dup->data.unstructured =
        lsmash_memdup(specific->data.unstructured, specific->size);
...
static int isom_construct_global_specific_header(lsmash_codec_specific_t *dst,
                                                 lsmash_codec_specific_t *src) {
  if (src->size < ISOM_BASEBOX_COMMON_SIZE)
    return LSMASH_ERR_INVALID_DATA;
  lsmash_codec_global_header_t *global =
      (lsmash_codec_global_header_t *)dst->data.structured;
...
static int isom_construct_audio_channel_layout(lsmash_codec_specific_t *dst,
                                               lsmash_codec_specific_t *src) {
  if (src->size < ISOM_FULLBOX_COMMON_SIZE + 12)
    return LSMASH_ERR_INVALID_DATA;
  lsmash_qt_audio_channel_layout_t *layout =
      (lsmash_qt_audio_channel_layout_t *)dst->data.structured;
  uint8_t *data = src->data.unstructured;
  uint64_t size = LSMASH_GET_BE32(data);
 ...
 * since structured formats we defined don't always have all contents included
 * in unstructured data. */
lsmash_codec_specific_t *
lsmash_convert_codec_specific_format(lsmash_codec_specific_t *specific,
                                     lsmash_codec_specific_format format) {
  ...
  lsmash_codec_specific_t *dst =
      lsmash_create_codec_specific_data(specific->type, format);
  if (!dst)
    return NULL;
  if (format == LSMASH_CODEC_SPECIFIC_FORMAT_UNSTRUCTURED)
    ...
    switch (specific->type) {
    case LSMASH_CODEC_SPECIFIC_DATA_TYPE_MP4SYS_DECODER_CONFIG:
      dst->data.unstructured = lsmash_create_mp4sys_decoder_config(
          (lsmash_mp4sys_decoder_parameters_t *)specific->data.structured,
          &dst->size);
      if (!dst->data.unstructured)
        goto fail;
      return dst;
    case LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_VIDEO_H264:
      dst->data.unstructured = lsmash_create_h264_specific_info(
          (lsmash_h264_specific_parameters_t *)specific->data.structured,
          &dst->size);
      if (!dst->data.unstructured)
        goto fail;
      return dst;
    case LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_VIDEO_HEVC:
      dst->data.unstructured = lsmash_create_hevc_specific_info(
          (lsmash_hevc_specific_parameters_t *)specific->data.structured,
          &dst->size);
      if (!dst->data.unstructured)
        goto fail;
      return dst;
    case LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_VIDEO_VC_1:
      dst->data.unstructured = lsmash_create_vc1_specific_info(
          (lsmash_vc1_specific_parameters_t *)specific->data.structured,
          &dst->size);
      if (!dst->data.unstructured)
        goto fail;
      return dst;
    case LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_AUDIO_AC_3:
      dst->data.unstructured = lsmash_create_ac3_specific_info(
          (lsmash_ac3_specific_parameters_t *)specific->data.structured,
          &dst->size);
      if (!dst->data.unstructured)
        goto fail;
      return dst;
    case LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_AUDIO_EC_3:
      dst->data.unstructured = lsmash_create_eac3_specific_info(
          (lsmash_eac3_specific_parameters_t *)specific->data.structured,
          &dst->size);
      if (!dst->data.unstructured)
        goto fail;
      return dst;
    case LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_AUDIO_DTS:
      dst->data.unstructured = lsmash_create_dts_specific_info(
          (lsmash_dts_specific_parameters_t *)specific->data.structured,
          &dst->size);
      if (!dst->data.unstructured)
        goto fail;
      return dst;
    case LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_AUDIO_ALAC:
      dst->data.unstructured = lsmash_create_alac_specific_info(
          (lsmash_alac_specific_parameters_t *)specific->data.structured,
          &dst->size);
      if (!dst->data.unstructured)
        goto fail;
      return dst;
    case LSMASH_CODEC_SPECIFIC_DATA_TYPE_CODEC_GLOBAL_HEADER: {
      ...
      if (!dst->data.unstructured ||
          dst->size != (ISOM_BASEBOX_COMMON_SIZE + global->header_size))
        goto fail;
      return dst;
    }
    default:
    ...
    extern int mp4sys_construct_decoder_config(lsmash_codec_specific_t *,
                                               lsmash_codec_specific_t *);
    extern int h264_construct_specific_parameters(lsmash_codec_specific_t *,
                                                  lsmash_codec_specific_t *);
    extern int hevc_construct_specific_parameters(lsmash_codec_specific_t *,
                                                  lsmash_codec_specific_t *);
    extern int vc1_construct_specific_parameters(lsmash_codec_specific_t *,
                                                 lsmash_codec_specific_t *);
    extern int ac3_construct_specific_parameters(lsmash_codec_specific_t *,
                                                 lsmash_codec_specific_t *);
    extern int eac3_construct_specific_parameters(lsmash_codec_specific_t *,
                                                  lsmash_codec_specific_t *);
    extern int dts_construct_specific_parameters(lsmash_codec_specific_t *,
                                                 lsmash_codec_specific_t *);
    extern int alac_construct_specific_parameters(lsmash_codec_specific_t *,
                                                  lsmash_codec_specific_t *);
    static const struct {
    ...
    for (int i = 0; codec_specific_format_constructor_table[i].constructor; i++)
      if (specific->type ==
          codec_specific_format_constructor_table[i].data_type) {
...
static inline void
isom_set_default_compressorname(char *compressorname,
  ...
  if (compressorname_table[0].name[0] == '\0') {
    int i = 0;
#define ADD_COMPRESSORNAME_TABLE(type, name)                                   \
  compressorname_table[i++] = (struct compressorname_table_tag){type, name}
    ...
    ADD_COMPRESSORNAME_TABLE(QT_CODEC_TYPE_APCH_VIDEO,
                             "\023Apple ProRes 422 (HQ)");
    ADD_COMPRESSORNAME_TABLE(QT_CODEC_TYPE_APCN_VIDEO,
                             "\023Apple ProRes 422 (SD)");
    ADD_COMPRESSORNAME_TABLE(QT_CODEC_TYPE_APCS_VIDEO,
                             "\023Apple ProRes 422 (LT)");
    ADD_COMPRESSORNAME_TABLE(QT_CODEC_TYPE_APCO_VIDEO,
                             "\026Apple ProRes 422 (Proxy)");
    ADD_COMPRESSORNAME_TABLE(QT_CODEC_TYPE_AP4H_VIDEO, "\019Apple ProRes 4444");
    ADD_COMPRESSORNAME_TABLE(QT_CODEC_TYPE_AP4X_VIDEO,
    ...
    ADD_COMPRESSORNAME_TABLE(QT_CODEC_TYPE_UQY2_VIDEO,
...
#undef ADD_COMPRESSORNAME_TABLE
  ...
  for (int i = 0; compressorname_table[i].name[0] != '\0'; i++)
    if (lsmash_check_codec_type_identical(sample_type,
                                          compressorname_table[i].type)) {
...
lsmash_codec_specific_t *
isom_get_codec_specific(lsmash_codec_specific_list_t *opaque,
                        lsmash_codec_specific_data_type type) {
...
static int isom_check_valid_summary(lsmash_summary_t *summary) {
  ...
  temp_box.manager = summary->summary_type == LSMASH_SUMMARY_TYPE_AUDIO
                         ? LSMASH_AUDIO_DESCRIPTION
                         : 0;
  if (isom_is_lpcm_audio(&temp_box)) {
    if (isom_get_codec_specific(
            summary->opaque,
  ...
  if (isom_is_uncompressed_ycbcr(summary->sample_type)) {
    if (isom_get_codec_specific(
      ...
      if (!lsmash_check_codec_type_identical(summary->sample_type,
  ...
  lsmash_codec_specific_data_type required_data_type =
  ...
  else if (lsmash_check_codec_type_identical(sample_type,
  ...
  if (required_data_type == LSMASH_CODEC_SPECIFIC_DATA_TYPE_UNSPECIFIED)
    return 0;
  return isom_get_codec_specific(summary->opaque, required_data_type)
             ? 0
             : LSMASH_ERR_INVALID_DATA;
}

static lsmash_box_type_t
...
#define GUESS_VIDEO_CODEC_SPECIFIC_BOX_TYPE(codec_type, predefined_box_type)   \
            ...
            lsmash_check_codec_type_identical(active_codec_type,               \
                                              codec_type)) &&                  \
           box_type.fourcc == predefined_box_type.fourcc) box_type =           \
      predefined_box_type
  if (0)
    ;
  GUESS_VIDEO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_AVC1_VIDEO,
                                      ISOM_BOX_TYPE_AVCC);
  GUESS_VIDEO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_AVC2_VIDEO,
                                      ISOM_BOX_TYPE_AVCC);
  GUESS_VIDEO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_AVC3_VIDEO,
                                      ISOM_BOX_TYPE_AVCC);
  GUESS_VIDEO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_AVC4_VIDEO,
                                      ISOM_BOX_TYPE_AVCC);
  GUESS_VIDEO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_AVCP_VIDEO,
                                      ISOM_BOX_TYPE_AVCC);
  GUESS_VIDEO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_HVC1_VIDEO,
                                      ISOM_BOX_TYPE_HVCC);
  GUESS_VIDEO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_HEV1_VIDEO,
                                      ISOM_BOX_TYPE_HVCC);
  GUESS_VIDEO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_VC_1_VIDEO,
                                      ISOM_BOX_TYPE_DVC1);
  GUESS_VIDEO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_MP4V_VIDEO,
                                      ISOM_BOX_TYPE_ESDS);
  GUESS_VIDEO_CODEC_SPECIFIC_BOX_TYPE(LSMASH_CODEC_TYPE_UNSPECIFIED,
                                      ISOM_BOX_TYPE_BTRT);
  GUESS_VIDEO_CODEC_SPECIFIC_BOX_TYPE(LSMASH_CODEC_TYPE_UNSPECIFIED,
                                      QT_BOX_TYPE_FIEL);
  GUESS_VIDEO_CODEC_SPECIFIC_BOX_TYPE(LSMASH_CODEC_TYPE_UNSPECIFIED,
...
static int isom_setup_visual_description(isom_stsd_t *stsd,
                                         lsmash_video_summary_t *summary) {
  if (!summary ||
      LSMASH_IS_NON_EXISTING_BOX(stsd->parent->parent->parent->parent))
    return LSMASH_ERR_NAMELESS;
  int err = isom_check_valid_summary((lsmash_summary_t *)summary);
  if (err < 0)
    return err;
  isom_visual_entry_t *visual =
      isom_add_visual_description(stsd, summary->sample_type);
  ...
  for (lsmash_entry_t *entry = summary->opaque->list.head; entry;
    ...
    if (specific->type == LSMASH_CODEC_SPECIFIC_DATA_TYPE_UNKNOWN &&
      ...
      continue; /* LSMASH_CODEC_SPECIFIC_DATA_TYPE_UNKNOWN +
                   LSMASH_CODEC_SPECIFIC_FORMAT_STRUCTURED is not supported. */
    switch (specific->type) {
    case LSMASH_CODEC_SPECIFIC_DATA_TYPE_QT_VIDEO_COMMON: {
      if (specific->format == LSMASH_CODEC_SPECIFIC_FORMAT_UNSTRUCTURED)
        continue;
      lsmash_qt_video_common_t *data =
          (lsmash_qt_video_common_t *)specific->data.structured;
      ...
      if (data->color_table_ID == 0) {
        ...
        isom_qt_color_array_t *dst_array =
            lsmash_malloc_zero(element_count * sizeof(isom_qt_color_array_t));
        if (!dst_array) {
    ...
    case LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_VIDEO_SAMPLE_SCALE: {
      lsmash_codec_specific_t *cs = lsmash_convert_codec_specific_format(
          specific, LSMASH_CODEC_SPECIFIC_FORMAT_STRUCTURED);
      if (!cs)
        goto fail;
      lsmash_isom_sample_scale_t *data =
          (lsmash_isom_sample_scale_t *)cs->data.structured;
    ...
    case LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_VIDEO_H264_BITRATE: {
      ...
      if (!cs)
        goto fail;
      lsmash_h264_bitrate_t *data =
          (lsmash_h264_bitrate_t *)cs->data.structured;
    ...
    case LSMASH_CODEC_SPECIFIC_DATA_TYPE_QT_VIDEO_FIELD_INFO: {
      ...
      if (!cs)
        goto fail;
      lsmash_qt_field_info_t *data =
          (lsmash_qt_field_info_t *)cs->data.structured;
    ...
    case LSMASH_CODEC_SPECIFIC_DATA_TYPE_QT_VIDEO_PIXEL_FORMAT: {
      ...
      if (!cs)
        goto fail;
      lsmash_qt_pixel_format_t *data =
          (lsmash_qt_pixel_format_t *)cs->data.structured;
    ...
    case LSMASH_CODEC_SPECIFIC_DATA_TYPE_QT_VIDEO_SIGNIFICANT_BITS: {
      ...
      if (!cs)
        goto fail;
      lsmash_qt_significant_bits_t *data =
          (lsmash_qt_significant_bits_t *)cs->data.structured;
    ...
    case LSMASH_CODEC_SPECIFIC_DATA_TYPE_CODEC_GLOBAL_HEADER: {
      ...
      if (!cs)
        goto fail;
      lsmash_codec_global_header_t *data =
          (lsmash_codec_global_header_t *)cs->data.structured;
    ...
    default: {
      lsmash_codec_specific_t *cs = lsmash_convert_codec_specific_format(
          specific, LSMASH_CODEC_SPECIFIC_FORMAT_UNSTRUCTURED);
      if (!cs)
        goto fail;
      ...
      lsmash_compact_box_type_t fourcc =
          LSMASH_4CC(data[4], data[5], data[6], data[7]);
      lsmash_box_type_t box_type =
          isom_guess_video_codec_specific_box_type(visual->type, fourcc);
      /* Append the extension. */
      err =
          isom_add_extension_binary(visual, box_type, LSMASH_BOX_PRECEDENCE_HM,
                                    cs->data.unstructured, cs->size);
      cs->data.unstructured =
          NULL; /* Avoid freeing the binary data of the extension. */
      lsmash_destroy_codec_specific_data(cs);
      if (err < 0)
        goto fail;
      break;
  ...
  isom_trak_t *trak =
      (isom_trak_t *)visual->parent->parent->parent->parent->parent;
  int qt_compatible = trak->file->qt_compatible;
  isom_tapt_t *tapt = trak->tapt;
  isom_stsl_t *stsl = (isom_stsl_t *)isom_get_extension_box_format(
      &visual->extensions, ISOM_BOX_TYPE_STSL);
  int set_aperture_modes =
      qt_compatible /* Track Aperture Modes is only available under QuickTime
                       file format. */
      && (LSMASH_IS_NON_EXISTING_BOX(stsl) ||
          stsl->scale_method ==
      ...
      && ((isom_stsd_t *)visual->parent)->list.entry_count ==
             1; /* Multiple sample description might conflict with this, so in
                   that case, disable this feature. */
  if (!set_aperture_modes)
    isom_remove_box_by_itself(trak->tapt);
  int uncompressed_ycbcr =
      qt_compatible && isom_is_uncompressed_ycbcr(visual->type);
  /* Set up Clean Aperture. */
  if (set_aperture_modes || uncompressed_ycbcr ||
      (summary->clap.width.d && summary->clap.height.d &&
    ...
    if (LSMASH_IS_NON_EXISTING_BOX(clap))
      goto fail;
    if (summary->clap.width.d && summary->clap.height.d &&
        summary->clap.horizontal_offset.d && summary->clap.vertical_offset.d) {
  ...
  if (uncompressed_ycbcr || summary->color.primaries_index ||
      summary->color.transfer_index || summary->color.matrix_index ||
    ...
    if (qt_compatible && !trak->file->isom_compatible) {
      ...
      colr->primaries_index =
          (primaries == 1 || (primaries >= 4 && primaries <= 7))
              ? primaries
              : ISOM_PRIMARIES_INDEX_UNSPECIFIED;
      colr->transfer_function_index =
          (transfer == 1 || (transfer >= 4 && transfer <= 8) ||
           (transfer >= 11 && transfer <= 13))
              ? transfer
  ...
  if (set_aperture_modes) {
    ...
    isom_clap_t *clap = (isom_clap_t *)isom_get_extension_box_format(
        &visual->extensions, ISOM_BOX_TYPE_CLAP);
    isom_pasp_t *pasp = (isom_pasp_t *)isom_get_extension_box_format(
        &visual->extensions, ISOM_BOX_TYPE_PASP);
    double clap_width =
        ((double)clap->cleanApertureWidthN / clap->cleanApertureWidthD) *
        (1 << 16);
    double clap_height =
        ((double)clap->cleanApertureHeightN / clap->cleanApertureHeightD) *
        (1 << 16);
...
static int
isom_append_audio_es_descriptor_extension(isom_box_t *box,
                                          lsmash_audio_summary_t *summary) {
  uint32_t esds_size = 0;
  uint8_t *esds_data = NULL;
  lsmash_codec_specific_t *specific = isom_get_codec_specific(
      summary->opaque, LSMASH_CODEC_SPECIFIC_DATA_TYPE_MP4SYS_DECODER_CONFIG);
  if (!specific)
    return LSMASH_ERR_NAMELESS;
  if (specific->format == LSMASH_CODEC_SPECIFIC_FORMAT_UNSTRUCTURED) {
    ...
    esds_data = lsmash_create_mp4sys_decoder_config(
        (lsmash_mp4sys_decoder_parameters_t *)specific->data.structured,
        &esds_size);
    if (!esds_data)
      return LSMASH_ERR_NAMELESS;
...
static int
isom_append_channel_layout_extension(lsmash_codec_specific_t *specific,
                                     void *parent, uint32_t channels) {
  assert(LSMASH_IS_EXISTING_BOX((isom_box_t *)parent));
  if (isom_get_extension_box(&((isom_box_t *)parent)->extensions,
                             QT_BOX_TYPE_CHAN))
  ...
  if (!cs)
    return LSMASH_ERR_NAMELESS;
  lsmash_qt_audio_channel_layout_t *data =
      (lsmash_qt_audio_channel_layout_t *)cs->data.structured;
  lsmash_channel_layout_tag channelLayoutTag = data->channelLayoutTag;
  lsmash_channel_bitmap channelBitmap = data->channelBitmap;
  if (channelLayoutTag ==
          QT_CHANNEL_LAYOUT_USE_CHANNEL_DESCRIPTIONS /* We don't support the
                                                        feature of Channel
                                                        Descriptions. */
      || (channelLayoutTag == QT_CHANNEL_LAYOUT_USE_CHANNEL_BITMAP &&
          (!channelBitmap || channelBitmap > QT_CHANNEL_BIT_FULL))) {
...
static int isom_set_qtff_mp4a_description(isom_audio_entry_t *audio,
  ...
  if ((wave = isom_add_wave(audio), LSMASH_IS_NON_EXISTING_BOX(wave)) ||
      ...
      (terminator = isom_add_terminator(wave),
  ...
  int err =
      isom_append_audio_es_descriptor_extension((isom_box_t *)wave, summary);
  if (err < 0)
    return err;
  /* */
  audio->type = QT_CODEC_TYPE_MP4A_AUDIO;
  audio->version =
      (summary->channels > 2 || summary->frequency > UINT16_MAX) ? 2 : 1;
  audio->channelcount =
      audio->version == 2 ? 3 : LSMASH_MIN(summary->channels, 2);
  audio->samplesize = 16;
...
static int isom_set_isom_mp4a_description(isom_audio_entry_t *audio,
  ...
  lsmash_mp4sys_object_type_indication objectTypeIndication =
      lsmash_mp4sys_get_object_type_indication((lsmash_summary_t *)summary);
  ...
  /* Add ES Descriptor Box. */
  int err =
      isom_append_audio_es_descriptor_extension((isom_box_t *)audio, summary);
  if (err < 0)
    return err;
  /* In pure mp4 file, these "template" fields shall be default values according
     to the spec. But not pure - hybrid with other spec - mp4 file can take
     other values. Which is to say, these template values shall be ignored in
     terms of mp4, except some object_type_indications. see 14496-14, "Template
     fields used". */
  ...
  audio->samplerate =
      summary->frequency <= UINT16_MAX ? summary->frequency << 16 : 0;
  return 0;
}
...
static int isom_set_qtff_lpcm_description(isom_audio_entry_t *audio,
  ...
  for (lsmash_entry_t *entry = summary->opaque->list.head; entry;
    ...
    if (specific->type ==
        ...
        specific->format == LSMASH_CODEC_SPECIFIC_FORMAT_STRUCTURED) {
      lpcm =
          (lsmash_qt_audio_format_specific_flags_t *)specific->data.structured;
      break;
    }
  }
  if (!lpcm)
  ...
  /* Convert the sample type into 'lpcm' if the description doesn't match the
   * format or version = 2 fields are needed. */
  if ((lsmash_check_codec_type_identical(sample_type,
                                         QT_CODEC_TYPE_RAW_AUDIO) &&
       (summary->sample_size != 8 ||
        (lpcm->format_flags & QT_LPCM_FORMAT_FLAG_FLOAT))) ||
      (lsmash_check_codec_type_identical(sample_type,
      ...
      (lsmash_check_codec_type_identical(sample_type,
       ...
       (summary->sample_size != 32 ||
        (lpcm->format_flags & QT_LPCM_FORMAT_FLAG_FLOAT) ||
        (lpcm->format_flags & QT_LPCM_FORMAT_FLAG_BIG_ENDIAN))) ||
      (lsmash_check_codec_type_identical(sample_type,
      ...
      (lsmash_check_codec_type_identical(sample_type,
       ...
       ((summary->sample_size != 16 && summary->sample_size != 8) ||
        (lpcm->format_flags & QT_LPCM_FORMAT_FLAG_FLOAT) ||
        !(lpcm->format_flags & QT_LPCM_FORMAT_FLAG_BIG_ENDIAN))) ||
      (lsmash_check_codec_type_identical(sample_type,
      ...
      (lsmash_check_codec_type_identical(sample_type,
       ...
       ((summary->sample_size != 16 && summary->sample_size != 8) ||
        (lpcm->format_flags & QT_LPCM_FORMAT_FLAG_FLOAT) ||
        !(lpcm->format_flags & QT_LPCM_FORMAT_FLAG_BIG_ENDIAN))) ||
      (summary->channels > 2 || summary->frequency > UINT16_MAX ||
       summary->sample_size % 8)) {
   ...
   * We use constBytesPerAudioPacket as the actual size of LPCM audio frame even
   * when version is not 2. */
  audio->constBytesPerAudioPacket =
      (summary->sample_size * summary->channels) / 8;
  ...
  if (audio->version == 2) {
    ...
    audio->samplesize = 16;
    /* Audio formats other than 'raw ' and 'twos' are treated as compressed
     * audio. */
    if (lsmash_check_codec_type_identical(sample_type,
                                          QT_CODEC_TYPE_RAW_AUDIO) ||
        lsmash_check_codec_type_identical(sample_type,
    ...
    audio->bytesPerFrame =
        ...
        summary->channels; /* sample_size field in stsz box is NOT used. */
...
static int
isom_set_isom_dts_audio_description(isom_audio_entry_t *audio,
                                    lsmash_audio_summary_t *summary) {
  audio->version = 0;
  audio->revision_level = 0;
  audio->vendor = 0;
...
#define GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(codec_type, predefined_box_type)   \
  ...
  if (0)
    ;
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_AC_3_AUDIO,
                                      ISOM_BOX_TYPE_DAC3);
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_EC_3_AUDIO,
                                      ISOM_BOX_TYPE_DEC3);
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_DTSC_AUDIO,
                                      ISOM_BOX_TYPE_DDTS);
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_DTSE_AUDIO,
                                      ISOM_BOX_TYPE_DDTS);
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_DTSH_AUDIO,
                                      ISOM_BOX_TYPE_DDTS);
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_DTSL_AUDIO,
                                      ISOM_BOX_TYPE_DDTS);
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_DTSX_AUDIO,
                                      ISOM_BOX_TYPE_DDTS);
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_DTSEL_AUDIO,
                                      ISOM_BOX_TYPE_DDTS);
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_DTSDL_AUDIO,
                                      ISOM_BOX_TYPE_DDTS);
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_ALAC_AUDIO,
                                      ISOM_BOX_TYPE_ALAC);
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(ISOM_CODEC_TYPE_MP4A_AUDIO,
                                      ISOM_BOX_TYPE_ESDS);
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(QT_CODEC_TYPE_ALAC_AUDIO,
                                      QT_BOX_TYPE_ALAC);
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(QT_CODEC_TYPE_MP4A_AUDIO,
                                      QT_BOX_TYPE_ESDS);
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(QT_CODEC_TYPE_FULLMP3_AUDIO,
                                      QT_CODEC_TYPE_MP3_AUDIO);
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(QT_CODEC_TYPE_ADPCM2_AUDIO,
                                      QT_CODEC_TYPE_ADPCM2_AUDIO);
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(QT_CODEC_TYPE_ADPCM17_AUDIO,
                                      QT_CODEC_TYPE_ADPCM17_AUDIO);
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(QT_CODEC_TYPE_GSM49_AUDIO,
                                      QT_CODEC_TYPE_GSM49_AUDIO);
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(LSMASH_CODEC_TYPE_UNSPECIFIED,
                                      QT_BOX_TYPE_CHAN);
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(LSMASH_CODEC_TYPE_UNSPECIFIED,
                                      QT_BOX_TYPE_GLBL);
  GUESS_AUDIO_CODEC_SPECIFIC_BOX_TYPE(LSMASH_CODEC_TYPE_UNSPECIFIED,
...
static lsmash_bs_t *isom_create_waveform_audio_info(wave_format_ex_t *wfx,
...
static int isom_setup_waveform_audio_info(isom_wave_t *wave,
  ...
  wfx.cbSize = 0;
  lsmash_bs_t *bs = NULL;
  if (lsmash_check_codec_type_identical(audio->type,
                                        QT_CODEC_TYPE_ADPCM2_AUDIO)) {
    /* ADPCMWAVEFORMAT */
    ...
    uint16_t wSamplesPerBlock =
        samples_per_packet; /* nBlockAlign * 2 / nChannels - 12 */
    uint16_t wNumCoef = 7;  /* Microsoft ADPCM uses just 7 coefficients. */
    static const struct {
      int16_t iCoef1;
      int16_t iCoef2;
    } aCoef[7] = {{256, 0}, {512, -256}, {0, 0},     {192, 64},
  ...
  } else if (lsmash_check_codec_type_identical(audio->type,
                                               QT_CODEC_TYPE_ADPCM17_AUDIO)) {
    /* IMAADPCMWAVEFORMAT */
    ...
    lsmash_bs_put_le16(bs, wSamplesPerBlock);
             ...
             lsmash_check_codec_type_identical(audio->type,
                                               QT_CODEC_TYPE_MP3_AUDIO)) {
  ...
  int err = isom_add_extension_binary(
      wave, audio->type, LSMASH_BOX_PRECEDENCE_HM, wfx_data, wfx_size);
  if (err < 0) {
    lsmash_free(wfx_data);
    return err;
  }
...
static int isom_set_qtff_sound_decompression_parameters(
    isom_audio_entry_t *audio, lsmash_audio_summary_t *summary,
    lsmash_qt_audio_format_specific_flag *format_flags,
    uint32_t samples_per_packet, uint32_t bytes_per_frame,
    uint32_t sample_size) {
  /* A 'wave' extension itself shall be absent in the opaque CODEC specific info
   * list. So, create a 'wave' extension here and append it as an extension to
   * the audio sample description. */
  ...
  /* Append extensions from the opaque CODEC specific info list to 'wave'
   * extension. */
  int err;
  ...
  for (lsmash_entry_t *entry = summary->opaque->list.head; entry;
    ...
    case LSMASH_CODEC_SPECIFIC_DATA_TYPE_QT_AUDIO_CHANNEL_LAYOUT:
      /* (Legacy?) ALAC might have an Audio Channel Layout Box inside 'wave'
       * extension. */
#if 1
      continue;
#else
      if (lsmash_check_codec_type_identical(audio->type,
                                            QT_CODEC_TYPE_ALAC_AUDIO))
        continue;
      if ((err = isom_append_channel_layout_extension(specific, wave,
                                                      summary->channels)) < 0)
        return err;
      break;
#endif
    default: {
      ...
      lsmash_compact_box_type_t fourcc =
          LSMASH_4CC(box_data[4], box_data[5], box_data[6], box_data[7]);
      ...
      lsmash_box_type_t box_type =
          isom_guess_audio_codec_specific_box_type(audio->type, fourcc);
  ...
  if (requires_waveform_audio_info && !waveform_audio_info_present &&
      (err = isom_setup_waveform_audio_info(wave, audio, summary,
...
static int
isom_set_qtff_template_audio_description(isom_audio_entry_t *audio,
                                         lsmash_audio_summary_t *summary) {
  audio->manager |= LSMASH_QTFF_BASE;
  ...
  for (lsmash_entry_t *entry = summary->opaque->list.head; entry;
       entry = entry->next) {
    lsmash_codec_specific_t *specific = (lsmash_codec_specific_t *)entry->data;
    if (!specific || !specific->data.structured)
      continue;
    if (specific->type ==
            LSMASH_CODEC_SPECIFIC_DATA_TYPE_QT_AUDIO_FORMAT_SPECIFIC_FLAGS &&
        specific->format == LSMASH_CODEC_SPECIFIC_FORMAT_STRUCTURED) {
  ...
  uint32_t bytes_per_frame;
  uint32_t sample_size;
  if (!((summary->samples_in_frame == 0 || summary->bytes_per_frame == 0 ||
         summary->sample_size == 0) &&
        isom_get_implicit_qt_fixed_comp_audio_sample_quants(
            audio, &samples_per_packet, &bytes_per_frame, &sample_size))) {
  ...
  if (!lsmash_check_codec_type_identical(audio->type,
    ...
    int err = isom_set_qtff_sound_decompression_parameters(
        audio, summary, &format_flags, samples_per_packet, bytes_per_frame,
        sample_size);
    if (err < 0)
      return err;
  }
  ...
  } else /* if( audio->version == 1 ) */
  {
    ...
    audio->bytesPerFrame =
        bytes_per_frame; /* sample_size field in stsz box is NOT used. */
...
static void
isom_set_samplerate_division_of_media_timescale(isom_audio_entry_t *audio,
                                                int strict) {
  isom_mdia_t *mdia = (isom_mdia_t *)audio->parent->parent->parent
                          ->parent; /* audio_entry->stsd->stbl->minf->mdia */
  if (lsmash_check_box_type_identical(mdia->type, ISOM_BOX_TYPE_MDIA) &&
      LSMASH_IS_EXISTING_BOX(mdia->mdhd)) {
    /* Make an effort to match the timescale with samplerate, or be an integer
     * multiple of it. */
    uint32_t orig_timescale =
        ((isom_mdia_t *)audio->parent->parent->parent->parent)->mdhd->timescale;
...
static int
isom_set_isom_template_audio_description(isom_audio_entry_t *audio,
                                         lsmash_audio_summary_t *summary) {
...
static int isom_set_isom_amr_audio_description(isom_audio_entry_t *audio,
                                               int wb) {
  ...
  /* Set samplerate by trying to copy from Media Header Box of this media though
   * the actual samplerate is 8000 Hz for AMR-NB and 16000 Hz for AMR-WB. 3GPP
   * and 3GPP2 has no restriction for media timescale. Therefore, users should
   * set suitable media timescale by themselves within the bounds of common
   * sense. */
...
static int
isom_set_isom_alac_audio_description(isom_audio_entry_t *audio,
                                     lsmash_audio_summary_t *summary) {
  return isom_set_isom_template_audio_description(audio, summary);
}

static int
isom_set_qtff_alac_audio_description(isom_audio_entry_t *audio,
                                     lsmash_audio_summary_t *summary) {
  return isom_set_qtff_template_audio_description(audio, summary);
}

static int
isom_set_isom_eac3_audio_description(isom_audio_entry_t *audio,
                                     lsmash_audio_summary_t *summary) {
  return isom_set_isom_template_audio_description(audio, summary);
}

static int isom_setup_audio_description(isom_stsd_t *stsd,
                                        lsmash_audio_summary_t *summary) {
  ...
  if (err < 0)
    return err;
  isom_audio_entry_t *audio =
      isom_add_audio_description(stsd, summary->sample_type);
  ...
  if (lsmash_check_codec_type_identical(audio_type,
                                        ISOM_CODEC_TYPE_MP4A_AUDIO) ||
      lsmash_check_codec_type_identical(audio_type, QT_CODEC_TYPE_MP4A_AUDIO)) {
    if ((LSMASH_IS_EXISTING_BOX(file->ftyp) &&
         file->ftyp->major_brand == ISOM_BRAND_TYPE_QT) ||
        (LSMASH_IS_NON_EXISTING_BOX(file->ftyp) &&
         (file->qt_compatible ||
          (LSMASH_IS_EXISTING_BOX(file->moov) &&
           LSMASH_IS_NON_EXISTING_BOX(file->moov->iods)))))
  ...
  else if (file->isom_compatible && lsmash_check_codec_type_identical(
                                        audio_type, ISOM_CODEC_TYPE_ALAC_AUDIO))
    err = isom_set_isom_alac_audio_description(audio, summary);
  else if (file->qt_compatible && lsmash_check_codec_type_identical(
                                      audio_type, QT_CODEC_TYPE_ALAC_AUDIO))
  ...
  else if (lsmash_check_codec_type_identical(audio_type,
                                             ISOM_CODEC_TYPE_EC_3_AUDIO))
  ...
  for (lsmash_entry_t *entry = summary->opaque->list.head; entry;
    ...
    case LSMASH_CODEC_SPECIFIC_DATA_TYPE_QT_AUDIO_CHANNEL_LAYOUT: {
      if (!file->qt_compatible &&
          ...
          !lsmash_check_codec_type_identical(audio->type,
                                             QT_CODEC_TYPE_ALAC_AUDIO))
        continue;
      if ((err = isom_append_channel_layout_extension(specific, audio,
                                                      summary->channels)) < 0)
        goto fail;
      break;
    }
    ...
    default: {
      ...
      /* Append the extension. */
      err = isom_add_extension_binary(audio, box_type, LSMASH_BOX_PRECEDENCE_HM,
                                      cs->data.unstructured, cs->size);
      cs->data.unstructured =
          NULL; /* Avoid freeing the binary data of the extension. */
      lsmash_destroy_codec_specific_data(cs);
...
static int isom_setup_tx3g_description(isom_stsd_t *stsd,
                                       lsmash_summary_t *summary) {
  isom_tx3g_entry_t *tx3g = isom_add_tx3g_description(stsd);
  if (LSMASH_IS_NON_EXISTING_BOX(tx3g))
    return LSMASH_ERR_NAMELESS;
  /* We create a dummy font record to make valid font_ID in the sample
   * description. The specification (3GPP TS 26.245) does not forbid the value 0
   * for the identifier, but we set 1 to it as track_ID begins from 1. */
...
static int isom_setup_qt_text_description(isom_stsd_t *stsd,
                                          lsmash_summary_t *summary) {
...
int isom_setup_sample_description(isom_stsd_t *stsd,
                                  lsmash_media_type media_type,
                                  lsmash_summary_t *summary) {
  if (media_type == ISOM_MEDIA_HANDLER_TYPE_VIDEO_TRACK)
    return isom_setup_visual_description(stsd,
                                         (lsmash_video_summary_t *)summary);
  else if (media_type == ISOM_MEDIA_HANDLER_TYPE_AUDIO_TRACK)
    return isom_setup_audio_description(stsd,
                                        (lsmash_audio_summary_t *)summary);
...
static lsmash_codec_specific_data_type
...
#define ADD_CODEC_SPECIFIC_DATA_TYPE_TABLE_ELEMENT(extension_type, data_type)  \
  codec_specific_data_type_table[i++] =                                        \
    ...
    ADD_CODEC_SPECIFIC_DATA_TYPE_TABLE_ELEMENT(
        ISOM_BOX_TYPE_ALAC, LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_AUDIO_ALAC);
    ADD_CODEC_SPECIFIC_DATA_TYPE_TABLE_ELEMENT(
        ISOM_BOX_TYPE_ESDS,
        LSMASH_CODEC_SPECIFIC_DATA_TYPE_MP4SYS_DECODER_CONFIG);
    ADD_CODEC_SPECIFIC_DATA_TYPE_TABLE_ELEMENT(
    ...
    // ADD_CODEC_SPECIFIC_DATA_TYPE_TABLE_ELEMENT(   QT_BOX_TYPE_ALAC,
    // LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_AUDIO_ALAC );
    // ADD_CODEC_SPECIFIC_DATA_TYPE_TABLE_ELEMENT(   QT_BOX_TYPE_ESDS,
    // LSMASH_CODEC_SPECIFIC_DATA_TYPE_MP4SYS_DECODER_CONFIG );
    ADD_CODEC_SPECIFIC_DATA_TYPE_TABLE_ELEMENT(
    ...
    ADD_CODEC_SPECIFIC_DATA_TYPE_TABLE_ELEMENT(
        LSMASH_BOX_TYPE_UNSPECIFIED, LSMASH_CODEC_SPECIFIC_DATA_TYPE_UNKNOWN);
#undef ADD_CODEC_SPECIFIC_DATA_TYPE_TABLE_ELEMENT
  }
  lsmash_codec_specific_data_type data_type =
      LSMASH_CODEC_SPECIFIC_DATA_TYPE_UNKNOWN;
  for (int i = 0; codec_specific_data_type_table[i].data_type !=
                  LSMASH_CODEC_SPECIFIC_DATA_TYPE_UNKNOWN;
       i++)
    if (extension_fourcc ==
        codec_specific_data_type_table[i].extension_fourcc) {
...
lsmash_summary_t *
isom_create_video_summary_from_description(isom_sample_entry_t *sample_entry) {
  if (LSMASH_IS_NON_EXISTING_BOX(sample_entry))
    return NULL;
  isom_visual_entry_t *visual = (isom_visual_entry_t *)sample_entry;
  lsmash_video_summary_t *summary =
      (lsmash_video_summary_t *)lsmash_create_summary(
  ...
  for (lsmash_entry_t *entry = visual->extensions.head; entry;
       entry = entry->next) {
    ...
    if (!(box->manager & LSMASH_BINARY_CODED_BOX)) {
      ...
      if (lsmash_check_box_type_identical(box->type, ISOM_BOX_TYPE_CLAP)) {
        ...
        continue;
      } else if (lsmash_check_box_type_identical(box->type,
                                                 ISOM_BOX_TYPE_PASP)) {
        ...
        lsmash_isom_sample_scale_t *data =
            (lsmash_isom_sample_scale_t *)specific->data.structured;
        ...
        lsmash_h264_bitrate_t *data =
            (lsmash_h264_bitrate_t *)specific->data.structured;
        ...
        lsmash_qt_field_info_t *data =
            (lsmash_qt_field_info_t *)specific->data.structured;
        ...
        lsmash_qt_pixel_format_t *data =
            (lsmash_qt_pixel_format_t *)specific->data.structured;
        ...
        lsmash_qt_significant_bits_t *data =
            (lsmash_qt_significant_bits_t *)specific->data.structured;
        ...
        lsmash_codec_global_header_t *data =
            (lsmash_codec_global_header_t *)specific->data.structured;
...
static int isom_append_structured_mp4sys_decoder_config(
    lsmash_codec_specific_list_t *opaque, isom_esds_t *esds) {
  lsmash_bs_t *bs = lsmash_bs_create();
  if (!bs)
    return LSMASH_ERR_MEMORY_ALLOC;
  ...
  lsmash_codec_specific_data_type type =
      isom_get_codec_specific_data_type(ISOM_BOX_TYPE_ESDS.fourcc);
  lsmash_codec_specific_t *specific = lsmash_create_codec_specific_data(
      type, LSMASH_CODEC_SPECIFIC_FORMAT_UNSTRUCTURED);
  if (!specific) {
    lsmash_free(esds_data);
  ...
  /* Convert unstructured CODEC specific data format into structured, and append
   * it to the opaque list. */
  lsmash_codec_specific_t *conv = lsmash_convert_codec_specific_format(
      specific, LSMASH_CODEC_SPECIFIC_FORMAT_STRUCTURED);
  lsmash_destroy_codec_specific_data(specific);
  if (!conv)
    return LSMASH_ERR_NAMELESS;
...
lsmash_summary_t *
isom_create_audio_summary_from_description(isom_sample_entry_t *sample_entry) {
  ...
  if (((isom_stsd_t *)audio->parent)->version == 0 &&
      audio->file->qt_compatible && isom_is_qt_audio(audio->type)) {
    if (audio->version == 0)
      isom_get_implicit_qt_fixed_comp_audio_sample_quants(
          audio, &summary->samples_in_frame, &summary->bytes_per_frame,
          &summary->sample_size);
    else if (audio->version == 1) {
      summary->channels = audio->bytesPerPacket
    ...
    if (!specific)
      goto fail;
    lsmash_qt_audio_common_t *common =
        (lsmash_qt_audio_common_t *)specific->data.structured;
    ...
    if (isom_is_lpcm_audio(audio)) {
      ...
      if (!specific)
        goto fail;
      lsmash_qt_audio_format_specific_flags_t *data =
          (lsmash_qt_audio_format_specific_flags_t *)specific->data.structured;
      if (audio->version == 2)
        data->format_flags = audio->formatSpecificFlags;
      else {
        data->format_flags =
            QT_LPCM_FORMAT_FLAG_BIG_ENDIAN | QT_LPCM_FORMAT_FLAG_SIGNED_INTEGER;
        /* Here, don't override samplesize.
         * We should trust samplesize field in the description for misused CODEC
         * indentifier. */
        lsmash_codec_type_t audio_type = audio->type;
        if (lsmash_check_codec_type_identical(audio_type,
                                              QT_CODEC_TYPE_TWOS_AUDIO) ||
          ...
          } else if (lsmash_check_codec_type_identical(
                         audio_type, QT_CODEC_TYPE_23NI_AUDIO) ||
                     lsmash_check_codec_type_identical(
                         audio_type, QT_CODEC_TYPE_SOWT_AUDIO))
            data->format_flags &= ~QT_LPCM_FORMAT_FLAG_BIG_ENDIAN;
        }
      }
      isom_wave_t *wave = (isom_wave_t *)isom_get_extension_box_format(
          &audio->extensions, QT_BOX_TYPE_WAVE);
  ...
  for (lsmash_entry_t *entry = audio->extensions.head; entry;
       entry = entry->next) {
    isom_box_t *box = (isom_box_t *)entry->data;
    if (LSMASH_IS_NON_EXISTING_BOX(box))
      continue;
    if (!(box->manager & LSMASH_BINARY_CODED_BOX)) {
      if (lsmash_check_box_type_identical(box->type, QT_BOX_TYPE_CHAN)) {
        ...
        lsmash_qt_audio_channel_layout_t *data =
            (lsmash_qt_audio_channel_layout_t *)specific->data.structured;
        ...
        if (mp4sys_setup_summary_from_DecoderSpecificInfo(summary, esds->ES) <
                0 ||
            isom_append_structured_mp4sys_decoder_config(summary->opaque,
                                                         esds) < 0)
          goto fail;
      } else if (lsmash_check_box_type_identical(box->type,
                                                 ISOM_BOX_TYPE_SRAT)) {
        ...
        /* Don't append 'wave' extension itself to the opaque CODEC specific
         * info list. */
        isom_wave_t *wave = (isom_wave_t *)box;
        lsmash_bs_t *bs = lsmash_bs_create();
        if (!bs)
          goto fail;
        for (lsmash_entry_t *wave_entry = wave->extensions.head; wave_entry;
             wave_entry = wave_entry->next) {
          ...
          if (!(wave_ext->manager & LSMASH_BINARY_CODED_BOX)) {
            ...
            if (lsmash_check_box_type_identical(box_type, QT_BOX_TYPE_ENDA)) {
              ...
              if (LSMASH_IS_NON_EXISTING_BOX(esds) ||
                  mp4sys_setup_summary_from_DecoderSpecificInfo(summary,
                                                                esds->ES) < 0 ||
                  isom_append_structured_mp4sys_decoder_config(summary->opaque,
                                                               esds) < 0) {
                lsmash_bs_cleanup(bs);
              ...
              /* Skip Format Box and Terminator Box since they are mandatory and
               * fixed structure. */
              continue;
          } else {
          ...
          if (box_type.fourcc == QT_BOX_TYPE_CHAN.fourcc)
             ...
             * We distinguish it from one of the outside of 'wave' extension
             * here. */
            type =
                LSMASH_CODEC_SPECIFIC_DATA_TYPE_QT_AUDIO_DECOMPRESSION_PARAMETERS;
          else {
      ...
      if (specific->type == LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_AUDIO_DTS ||
        ...
        specific = lsmash_convert_codec_specific_format(
            specific, LSMASH_CODEC_SPECIFIC_FORMAT_STRUCTURED);
        if (!specific)
          goto fail;
        switch (specific->type) {
        case LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_AUDIO_DTS: {
          ...
          summary->samples_in_frame =
              (summary->frequency * (512 << param->FrameDuration)) /
              param->DTSSamplingFrequency;
          break;
        }
        case LSMASH_CODEC_SPECIFIC_DATA_TYPE_ISOM_AUDIO_AC_3: {
...
lsmash_codec_specific_t *
lsmash_get_codec_specific_data(lsmash_summary_t *summary,
...
int isom_compare_opaque_extensions(lsmash_summary_t *a, lsmash_summary_t *b) {
  ...
  for (uint32_t j = 1; j <= in_number_of_extensions; j++) {
    ...
    lsmash_codec_specific_format compare_format =
    ...
    if (in_cs_orig->format == LSMASH_CODEC_SPECIFIC_FORMAT_STRUCTURED) {
      if (in_cs_orig->type == LSMASH_CODEC_SPECIFIC_DATA_TYPE_QT_VIDEO_COMMON ||
        ...
        in_cs = lsmash_convert_codec_specific_format(
            in_cs_orig, LSMASH_CODEC_SPECIFIC_FORMAT_UNSTRUCTURED);
        if (!in_cs) {
    ...
    for (uint32_t k = 1; k <= out_number_of_extensions; k++) {
      lsmash_codec_specific_t *out_cs_orig =
          lsmash_get_codec_specific_data(b, k);
      ...
      if (out_cs_orig->format == LSMASH_CODEC_SPECIFIC_FORMAT_STRUCTURED) {
        if (compare_format == LSMASH_CODEC_SPECIFIC_FORMAT_STRUCTURED)
          ...
          out_cs = lsmash_convert_codec_specific_format(
              out_cs_orig, LSMASH_CODEC_SPECIFIC_FORMAT_UNSTRUCTURED);
          if (!out_cs)
            continue;
        }
      } else
      ...
      if (compare_format == LSMASH_CODEC_SPECIFIC_FORMAT_UNSTRUCTURED)
        identical = out_cs->size == in_cs->size &&
                    !memcmp(out_cs->data.unstructured, in_cs->data.unstructured,
                            in_cs->size);
      else {
        if (in_cs->type == LSMASH_CODEC_SPECIFIC_DATA_TYPE_QT_VIDEO_COMMON) {
          lsmash_qt_video_common_t *in_data =
              (lsmash_qt_video_common_t *)in_cs->data.structured;
          lsmash_qt_video_common_t *out_data =
              (lsmash_qt_video_common_t *)out_cs->data.structured;
          identical =
              in_data->revision_level == out_data->revision_level &&
              ...
              in_data->horizontal_resolution ==
                  out_data->horizontal_resolution &&
              ...
              in_data->color_table_ID == out_data->color_table_ID;
                   ...
                   LSMASH_CODEC_SPECIFIC_DATA_TYPE_QT_AUDIO_COMMON) {
          lsmash_qt_audio_common_t *in_data =
              (lsmash_qt_audio_common_t *)in_cs->data.structured;
          lsmash_qt_audio_common_t *out_data =
              (lsmash_qt_audio_common_t *)out_cs->data.structured;
          identical = in_data->revision_level == out_data->revision_level &&
                      in_data->vendor == out_data->vendor &&
                      in_data->compression_ID == out_data->compression_ID;
        } else {
          lsmash_qt_audio_format_specific_flags_t *in_data =
              (lsmash_qt_audio_format_specific_flags_t *)in_cs->data.structured;
          lsmash_qt_audio_format_specific_flags_t *out_data =
              (lsmash_qt_audio_format_specific_flags_t *)
                  out_cs->data.structured;
...
int isom_get_implicit_qt_fixed_comp_audio_sample_quants(
    isom_audio_entry_t *audio, uint32_t *samples_per_packet,
    uint32_t *constant_bytes_per_frame, uint32_t *sample_size) {
  if (lsmash_check_codec_type_identical(audio->type,
                                        QT_CODEC_TYPE_MAC3_AUDIO)) {
...
isom_bitrate_updater_t
isom_get_bitrate_updater(isom_sample_entry_t *sample_entry) {
#define RETURN_BITRATE_UPDATER(func_name)                                      \
  {                                                                            \
    extern int func_name(isom_stbl_t *, isom_mdhd_t *,                         \
